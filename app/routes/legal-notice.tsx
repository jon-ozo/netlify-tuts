		...
		<article className='policies'>
			<header>
				...
				<p className='italics no-animation'>
					In accordance with Articles 6-III and 19 of French Law No. 2004-575 of
					June 21, 2004 for Confidence in the Digital Economy (LCEN), users of
					the website <Link to='/'>www.advianpartners.com</Link> are informed of
					the following information regarding its ownership and management.
				</p>
			</header>
			<ol>
				<li>
				...
				<li>
					...
					<p className='no-animation'>
						...
						prohibited without prior written authorization from Advian Partners.{' '}
					</p>
				</li>
				...
				<li className='no-animation'>
					...
					<p className='no-animation'>
						While Advian Partners strives to ensure the accuracy and timeliness
						of the information published on this site, it cannot guarantee that
						it is free from errors or omissions. Users access and use this site
						at their own risk. Advian Partners cannot be held liable for any
						direct or indirect damages resulting from the use or inability to
						use the site.
					</p>
				</li>
				<li className='no-animation'>
					...
					<p className='no-animation'>
						This website is governed by the laws of France. Any dispute arising
						from its use shall fall under the exclusive jurisdiction of French
						courts.
					</p>
				</li>
			</ol>
