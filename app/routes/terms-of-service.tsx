			...
			<div className='container'>
				<header>
					...
					<p className='italics slide-in'>
						...
						the website and services provided by <b>Advian Partners</b>, a
						strategic advisory firm (“Advian Partners,” “we,” “us,” or “our”).
						By accessing or using our website at{' '}
						<Link to='/'>[www.advianpartners.com]</Link> (the “Site”), you agree
				...
				<ol>
					<li>
						...
						<p className='no-animation'>
							...
							provides general information about our firm and its services and
							may include contact forms, blog articles, case studies, or event
							information.
						</p>
					</li>
					<li>
					...
					<li>
						...
						<p className='no-animation'>
							...
							graphics, logos, trademarks, service marks, images, and
							software—is the intellectual property of Advian Partners or its
							...
							without prior written consent from Advian Partners.
						</p>
					</li>
					<li className='no-animation'>
						...
						<p className='no-animation'>
							...
							and accurate, we make no warranties or representations of any kind
							regarding:
						</p>
						<ul className='inner-list'>
							<li>
					...
					<li className='no-animation'>
						...
						<p className='no-animation'>
							To the fullest extent permitted by law, Advian Partners shall not
							...
							access to or use of the Site, or for any errors or omissions in
							the content.
						</p>
					</li>
					<li className='no-animation'>
					...
					<li className='no-animation'>
						...
						<p className='no-animation'>
							...
							provided by Advian Partners, you may contact us at: <br />
							<br />
